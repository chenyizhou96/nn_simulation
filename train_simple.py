...
train_loader = DataLoader(box_dataset, batch_size = 1, shuffle = True)
...
for epoch in range(1000):
  ...
  for i, constrained_pos_batch in enumerate(train_loader):
    ...
    loss, pos_batch = batch_mean_energy_loss(unconstrained_pos_batch, constrained_pos_batch, unconstrained_nodes, constrained_nodes, efem, corotated_psi, mu, lam)
    print(loss)
